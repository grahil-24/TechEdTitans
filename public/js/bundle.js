 ...
 */
        ...
        '../../node_modules/axios/lib/helpers/toFormData.js': [
            function (require, module, exports) {
                ...
                function isFlatArray(arr) {
                    return (
                        _utils.default.isArray(arr) && !arr.some(isVisitable)
                    );
                }
                ...
                function toFormData(obj, formData, options) {
                    ...
                    // eslint-disable-next-line no-param-reassign
                    formData =
                        formData || new (_FormData.default || FormData)();
            ...
            function (require, module, exports) {
                ...
                function buildURL(url, params, options) {
                    ...
                    if (serializeFn) {
                        ...
                        serializedParams = _utils.default.isURLSearchParams(
                            params
                        )
                            ? params.toString()
                            : new _AxiosURLSearchParams.default(
                                  params,
                                  options
                              ).toString(_encode);
                    }
        ...
        '../../node_modules/axios/lib/platform/browser/index.js': [
            function (require, module, exports) {
                ...
                var _Blob = _interopRequireDefault(
                    require('./classes/Blob.js')
                );
                function _interopRequireDefault(obj) {
                    return obj && obj.__esModule ? obj : { default: obj };
                }
                        ...
                        Object.assign(
                            {
                                visitor: function (value, key, path, helpers) {
                                    if (
                                        _index.default.isNode &&
                                        _utils.default.isBuffer(value)
                                    ) {
                                        this.append(
                                            key,
            ...
            function (require, module, exports) {
                ...
                function formDataToJSON(formData) {
                    function buildPath(path, value, target, index) {
                        ...
                        name =
                            !name && _utils.default.isArray(target)
                                ? target.length
                                : name;
                        if (isLast) {
                        ...
                        if (
                            !target[name] ||
                            !_utils.default.isObject(target[name])
                        ) {
                            target[name] = [];
                        }
                    ...
                    transformRequest: [
                        function transformRequest(data, headers) {
                            ...
                            const isObjectPayload =
                                _utils.default.isObject(data);
                            if (
                                isObjectPayload &&
                                _utils.default.isHTMLForm(data)
                            ) {
                            ...
                            if (isFormData) {
                                ...
                                return hasJSONContentType
                                    ? JSON.stringify(
                                          (0, _formDataToJSON.default)(data)
                                      )
                                    : data;
                            }
                            if (
                            ...
                            if (isObjectPayload) {
                                ...
                                if (
                                    (isFileList =
                                        _utils.default.isFileList(data)) ||
        ...
        '../../node_modules/axios/lib/core/AxiosHeaders.js': [
            function (require, module, exports) {
                ...
                function buildAccessors(obj, header) {
                    const accessorName = _utils.default.toCamelCase(
                        ' ' + header
                    );
                ...
                class AxiosHeaders {
                    ...
                    set(header, valueOrRewrite, rewrite) {
                        ...
                        if (
                            ...
                            setHeaders(
                                (0, _parseHeaders.default)(header),
                                valueOrRewrite
                            );
                        } else {
                            header != null &&
                    ...
                    delete(header, matcher) {
                        ...
                        function deleteHeader(_header) {
                            ...
                            if (_header) {
                                const key = _utils.default.findKey(
                                    self,
                                    _header
                                );
                                if (
                ...
                var _default =
                    ...
                    function (config) {
                        return new Promise(function dispatchXhrRequest(
                            ...
                            if (_index.default.isStandardBrowserEnv) {
                                ...
                                const xsrfValue =
                                    (config.withCredentials ||
                                        (0, _isURLSameOrigin.default)(
                                            fullPath
                                        )) &&
                                    config.xsrfCookieName &&
                                    _cookies.default.read(
                                        config.xsrfCookieName
                                    );
                                if (xsrfValue) {
                                    requestHeaders.set(
                            ...
                            const protocol = (0, _parseProtocol.default)(
                                fullPath
                            );
                            if (
                                protocol &&
                                _index.default.protocols.indexOf(protocol) ===
                                    -1
                            ) {
                                reject(
                                    new _AxiosError.default(
        ...
        '../../node_modules/axios/lib/adapters/adapters.js': [
            function (require, module, exports) {
                ...
                var _default = {
                    getAdapter: (adapters) => {
                        adapters = _utils.default.isArray(adapters)
                            ? adapters
                            : [adapters];
                        ...
                        for (let i = 0; i < length; i++) {
                            ...
                            if (
                                (adapter = _utils.default.isString(
                                    nameOrAdapter
                                )
                ...
                function dispatchRequest(config) {
                    ...
                    return adapter(config).then(
                        function onAdapterResolution(response) {
                            ...
                            response.headers = _AxiosHeaders.default.from(
                                response.headers
                            );
                            return response;
                        },
            ...
            function (require, module, exports) {
                ...
                class Axios {
                    ...
                    request(configOrUrl, config) {
                        ...
                        try {
                            promise = _dispatchRequest.default.call(
                                this,
                                newConfig
                            );
                        } catch (error) {
        ...
        '../../node_modules/axios/lib/helpers/isAxiosError.js': [
            function (require, module, exports) {
                ...
                function isAxiosError(payload) {
                    return (
                        _utils.default.isObject(payload) &&
        ...
        '../../node_modules/axios/lib/axios.js': [
            function (require, module, exports) {
                ...
                var _spread = _interopRequireDefault(
                    require('./helpers/spread.js')
                );
                ...
                function createInstance(defaultConfig) {
                    ...
                    _utils.default.extend(
                        instance,
                        _Axios.default.prototype,
                        context,
                        {
                            allOwnKeys: true,
                        }
                ...
                axios.formToJSON = (thing) =>
                    (0, _formDataToJSON.default)(
                        _utils.default.isHTMLForm(thing)
                            ? new FormData(thing)
                            : thing
                    );
            ...
            function (require, module, exports) {
                ...
                if (signupForm) {
                    signupForm.addEventListener('submit', function (e) {
                        ...
                        (0,
                        _signup.signup)(name, email, password, passwordConfirm, phoneNumber);
                    });
                }
            },
